...
if __name__ == '__main__':
    ...
    writer = SummaryWriter('runs/experiment_2/train_4')
    NUM_EPOCHS = 50
    ...
    checkpoint_files = glob.glob(
        "C:/Users/win11/PycharmProjects/pythonProject/checkpoint_2/hw2.1.2_checkpoint_epoch_*.pt")  # 获取所有的checkpoint文件
    ...
    if checkpoint_file_epochs:  # 如果存在checkpoint文件
        ...
        if valid_checkpoints:
            ...
            latest_checkpoint_file = f"C:/Users/win11/PycharmProjects/pythonProject/checkpoint_2/hw2.1.2_checkpoint_epoch_{latest_checkpoint_epoch}.pt"  # 生成最近的有效checkpoint的文件名
    ...
    for epoch in range(start_epoch,NUM_EPOCHS):
        ...
        if epoch % 10 == 9:
            ...
            }, f"C:/Users/win11/PycharmProjects/pythonProject/checkpoint_2/hw2.1.2_checkpoint_epoch_{epoch}.pt")
    torch.save(model.state_dict(), "C:/Users/win11/PycharmProjects/pythonProject/hw2.1.2.pt")
